...
class PowerFlowFeasibility:
    ...
    def run_feas_analysis(self,
        ...
        Ylin_dual, Jlin_dual = self.stamp_linear_dual(branch, transformer, shunt, slack, feasibility_sources, v_init)
        ...
        while NR_count < self.max_iters:
            ...
            (Ynlin_dual, Jnlin_dual) = self.stamp_nonlinear_dual(generator, load, v)
            ...
            #  You need to decide the input arguments and return values.
            Y = Ynlin + Ylin + Ynlin_dual + Ylin_dual
            J = Jnlin + Jlin + Jnlin_dual + Jlin_dual
            Y_check_nlin = Ynlin_dual.toarray(order='C',out=None)
            J_check_nlin = Jnlin_dual.toarray(order='C',out=None)
            Y_check = Y.toarray(order='C',out=None)
            J_check = J.toarray(order='C',out=None)
